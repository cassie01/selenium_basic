...
# # collect =driver.find_elements_by_css_selector
# # transmit = driver.find_elements_by_css_selector
# comments = driver.find_elements_by_partial_link_text("评论")
# agree = driver.find_elements_by_class_name("icon-act icon-act-praise")
...
for index in range(count):
    ...
    # ws.write(index + 1, 3, collect[index].text)
    # ws.write(index + 1, 4, transmit[index].text)
    # ws.write(index + 1, 5, comments[index].text)
